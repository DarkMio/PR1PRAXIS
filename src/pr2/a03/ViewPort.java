...
/**
 * Eine Klasse f�r einfache Grafiken.
 *
 * <br/><br/>
 *
 * Damit ist es m�glich ein Grafikfenster zu �ffnen, in dem
 * beliebige Grafiken dargestellt werden k�nnen.
 * Dabei wird mit einem Hintergrundspeicher gearbeitet.
 * Das hei�t, dass alle Punkte, die mit den Methoden
 * {@link #drawPix(int, int, java.awt.Color)} und
 * {@link #drawPix(int, int, int, int, int)}
 * gezeichnet werden zun�chst in einen Hintergrundspeicher
...
public class ViewPort {
     ...
     * @param height Die H�he des erzeugten Fensters.
     ...
     * bef�llt wird.
     *
     * Ein Aufruf dieser Methode bef�llt aber das Grafikfenster
     * nicht unmittelbar.
     *
    ...
    /**
     * Gibt die Farbe des Bildpunktes an den gegebenen Koordinaten zur�ck.
     *
    ...
    /**
     * Bef�llt den Hintergrundspeicher
     * mit der durch die Rot-, Gr�n-, und Blaukomponente
     ...
     * @param red Der Rotwert der Farbe des neuen Punktes. Zul�ssiger Bereich: 0-255.
     * @param green Der Gr�nwert der Farbe des neuen Punktes. Zul�ssiger Bereich: 0-255.
     * @param blue Der Blauwert der Farbe des neuen Punktes. Zul�ssiger Bereich: 0-255.
     */
     ...
     * @param x Die x-Koordinate des neu im Hintergrund zu setzenden Punktes.
     * @param y Die y-Koordinate des neu im Hintergrund zu setzenden Punktes.
     * @param col Die Farbe des neuen Punktes. Zul�ssiger Bereich: 0-255.
     */
     ...
     * {@link #setBackgroundColor(java.awt.Color)} eingestellt werden kann.
     */
    ...
    private int getColorCode(Color c) {
        return (c.getRed() << 16) + (c.getBlue() << 8) + c.getGreen();
    }
